//
//  PopCreateScheduleViewController.swift
//  AlphaFitness
//
...
class PopCreateScheduleViewController: UIViewController ,UITableViewDelegate, UITableViewDataSource {
    ...
    let dropdownButton: UIButton = {
        ...
        dropdownButton.setTitle("Select a day", for: .normal)
    ...
    override func viewDidLoad() {
        ...
        popupView.addSubview(scheduleName)
        popupView.addSubview(scheduleTime)
        popupView.addSubview(datePicker)
        popupView.addSubview(scheduleDay)
    ...
    func addConstraints(){
        ...
        NSLayoutConstraint.activate([
            scheduleName.topAnchor.constraint(equalTo: pgName.bottomAnchor, constant: 20),
            scheduleName.leadingAnchor.constraint(equalTo: popupView.leadingAnchor, constant: 20),
            scheduleName.trailingAnchor.constraint(equalTo: popupView.trailingAnchor, constant: -20),
            scheduleName.heightAnchor.constraint(equalToConstant: 45)
        ])
        
        NSLayoutConstraint.activate([
            scheduleTime.topAnchor.constraint(equalTo: scheduleName.bottomAnchor, constant: 20),
            scheduleTime.leadingAnchor.constraint(equalTo: popupView.leadingAnchor, constant: 20)
        ])
        NSLayoutConstraint.activate([
            datePicker.topAnchor.constraint(equalTo: scheduleTime.bottomAnchor, constant: 10),
            datePicker.leadingAnchor.constraint(equalTo: popupView.leadingAnchor, constant: 20)
        ])
        
        NSLayoutConstraint.activate([
            scheduleDay.topAnchor.constraint(equalTo: datePicker.bottomAnchor, constant: 20),
            scheduleDay.leadingAnchor.constraint(equalTo: popupView.leadingAnchor, constant: 20)
        ])
        
        NSLayoutConstraint.activate([
            dropdownButton.topAnchor.constraint(equalTo: scheduleDay.bottomAnchor, constant: 10),
