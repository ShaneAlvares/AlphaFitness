...
//                   addNavTitle()
            ...
            // Set the tab bar controller as the child view controller
//            addChild(mainTabBarController)
//            view.addSubview(mainTabBarController.view)
//            mainTabBarController.didMove(toParent: self)
//
//            // Adjust the layout of the tab bar controller's view
...
//            bottomNavBarController.view.translatesAutoresizingMaskIntoConstraints = false
//                    NSLayoutConstraint.activate([
//                        bottomNavBarController.view.leadingAnchor.constraint(equalTo: view.leadingAnchor),
//                        bottomNavBarController.view.trailingAnchor.constraint(equalTo: view.trailingAnchor),
//                        bottomNavBarController.view.bottomAnchor.constraint(equalTo: view.bottomAnchor),
//                        bottomNavBarController.view.heightAnchor.constraint(equalToConstant: 49) // Adjust the height as needed
//                    ])
            NSLayoutConstraint.activate([
