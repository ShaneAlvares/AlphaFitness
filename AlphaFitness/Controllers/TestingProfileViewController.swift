//
//  TestingProfileViewController.swift
//  AlphaFitness
//
...
class TestingProfileViewController: UIViewController {
    ...
    func addConstraints(){
        ...
        NSLayoutConstraint.activate([
            bmiLabel.topAnchor.constraint(equalTo: infoLabel.bottomAnchor, constant: 20),
        ...
        NSLayoutConstraint.activate([
            popularWorkoutsCard.topAnchor.constraint(equalTo: bmiLabel.bottomAnchor, constant: 20),
